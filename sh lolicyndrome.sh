...
cat <<EOF
             - https://xvideos.com -
          [+] LOLICYNDROME - PADANG CYBER TEAM [+]
        
-----------------------------------------------------------------------
   UDAH DIKASIH JANGAN NGELUNJAK BANGSAT - AppleID Validator 2019
-----------------------------------------------------------------------
...
Report any bugs to: <lolicyndrome> tepot.3003@gmail.com
"
  exit 1 
}
...
echo "+==========+ UDAH DIKASIH JANGAN NGELUNJAK BANGSAT - AppleID Validator 2019 - Lolicyndrome +==========+"
